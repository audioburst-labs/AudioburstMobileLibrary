...
internal class BackToBurstStrategyTest {

    private val strategy = BackToBurstStrategy()
    ...
    fun testHappyPath() {
        ...
        // THEN
        assertTrue(playbackEvent is PlaybackEvent.BackToBurst)
    }

    @Test
    fun testWhenPreviousAndCurrentStatesUrlIsTheSame() {
        // GIVEN
        val sourceAudioUrl = "audioUrl"
        val playlist = playlistOf(
            bursts = listOf(
                burstOf(
                    source = burstSourceOf(
